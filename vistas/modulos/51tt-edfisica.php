...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        5to. Año Primera TT - Area Educación Física
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">5to. Año Primera TT - Area Educación Física</li>
      </ol>
    </section>
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=12 tabla="quinto" data-toggle="modal" periodo="'.$_SESSION['periodo'].'" data-target="#modalCopiaSaberes">
                 ...
                 <button class="btn btn-primary btnInformeArea" area="edfisica" idCurso=12 tabla="quinto" periodo="'.$_SESSION['periodo'].'" informe="informe-area">
