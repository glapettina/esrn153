...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        1er. Año TT - Area Lenguajes Artísticos
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">1er. Año TT - Area Lenguajes Artísticos</li>
      </ol>
    </section>
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=2 tabla="primero" data-toggle="modal" periodo="'.$_SESSION['periodo'].'" data-target="#modalCopiaSaberes">
                 ...
                 <button class="btn btn-primary btnInformeArea" periodo="'.$_SESSION['periodo'].'" area="artistica" idCurso=2 tabla="primero" informe="informe-area">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeArtistica" tabla="primero" idAlumno="'.$value["id"].'" data-toggle="modal" periodo="'.$_SESSION['periodo'].'" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                            ...
                            echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" tabla="primero" periodo="'.$_SESSION['periodo'].'" area="artistica" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
