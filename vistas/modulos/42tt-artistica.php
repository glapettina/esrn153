...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        4to. Año 2da. TT - Area Lenguajes Artísticos
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">4to. Año 2da. TT - Area Lenguajes Artísticos</li>
      </ol>
    </section>
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=9 tabla="cuarto" data-toggle="modal" periodo="'.$_SESSION['periodo'].'" data-target="#modalCopiaSaberes">
                 ...
                 <button class="btn btn-primary btnInformeArea" area="artistica" idCurso=9 tabla="cuarto" periodo="'.$_SESSION['periodo'].'" informe="informe-area">
