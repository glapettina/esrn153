...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        5to. Año Segunda TT - Area Educación Física
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">5to. Año Segunda TT - Area Educación Física</li>
      </ol>
    </section>
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=13 tabla="quinto" data-toggle="modal" periodo="'.$_SESSION['periodo'].'" data-target="#modalCopiaSaberes">
                 ...
                 <button class="btn btn-primary btnInformeArea" area="edfisica" idCurso=13 tabla="quinto" periodo="'.$_SESSION['periodo'].'" informe="informe-area">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeFisica" tabla="quinto" idAlumno="'.$value["id"].'" data-toggle="modal" periodo="'.$_SESSION['periodo'].'" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
        ...
        <!-- ENTRADA PARA LA APRECIACION --> 
              ...
              <div class="form-group">          
                  <label for="observaFisica">Observaciones</label>
                      <textarea class="textinput" cols="80" rows="3" id="observaFisica" name="observaFisica">
                  </textarea>
              </div>
